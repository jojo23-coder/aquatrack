...
const LogForm: React.FC<Props> = ({ onAdd, initialData }) => {
  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        gh: String(initialData.gh ?? ''),
        kh: String(initialData.kh ?? ''),
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAdd({
      ...
      pH: toOptionalNumber(formData.pH),
      ammonia: toOptionalNumber(formData.ammonia),
      nitrite: toOptionalNumber(formData.nitrite),
      nitrate: toOptionalNumber(formData.nitrate),
      gh: toOptionalNumber(formData.gh),
      kh: toOptionalNumber(formData.kh),
